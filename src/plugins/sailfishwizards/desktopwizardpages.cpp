...
/*!
  ...
  */
QString DesktopLocationPage::getDefaultPath() const
{
...
/*!
  ...
  * file for adding icons.
  */
int DesktopLocationPage::getIconsIndex() const
{
    return m_iconsIndex;
}
...
/*!
  ...
  */
Ui::DesktopIconPage DesktopIconPage::Ui()
{
    return m_pageUi;
}
 ...
 * \param translation Translation of application name.
 */
void TranslationData::setTranslation(const QString &translation)
{
    m_translation = translation;
}
 ...
 */
void TranslationData::setLanguage(const QString &language)
{
    m_language = language;
}
 ...
 */
QString TranslationData::getTranslation() const
{
 ...
 */
QString TranslationData::getLanguage() const
{
    return m_language;
}
 ...
 */
Ui::DesktopFileSettingPage DesktopSettingPage::Ui()
{
    return m_settingUi;
}
 ...
 */
TranslationTableModel *DesktopSettingPage::getLangTableModel() const
{
